...
export default defineConfig<ThemeConfig>({
    ...
    themeConfig: {
        beecodeurl: 'https://qifeiai.top/', //这里是内页ArticleLink组件用到的跳转第三方网址，一般用不到，仅仅用于二次开发
        sidebar: [{}], //这里如果删掉，左侧栏的内容全部不显示。页面布局会变成通栏
        nav: [
            { text: '棋飞博客', link: 'https://qifeiai.top/' },
        ...
        website: {
            ...
            coffeeQrcode: 'https://qifei-blog-1256009448.cos.ap-chengdu.myqcloud.com/qifei-blog/202405221038892.png', //打赏咖啡二维码图片地址。如果是跳转网页地址需自行修改代码
